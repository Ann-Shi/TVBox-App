package com.example.project2_tvbox_ui_1;
...
public class Candy_Crush extends AppCompatActivity {
    ...
    int[] candy= {R.drawable.fruit13, R.drawable.fruit15,R.drawable.fruit24,R.drawable.fruit25,R.drawable.fruit26};

    int withblock,noblock2= 8, screen;
    ArrayList<ImageView> canddy= new ArrayList<>();
    int candyDrag,candyReplace;
    int noCandy=R.drawable.cancel1;
    Handler mhandler;
    int interval=100;
